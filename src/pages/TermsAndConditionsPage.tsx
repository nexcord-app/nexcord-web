      ...
      <Content class="content">
        <CenterContainer>
          <InformationContainer>
            <Title>Nexcord Terms and Conditions of Use</Title>
            ...
            <Text opacity={0.6} size={14}>
              ...
              us at{" "}
              <a href="mailto:nexcordapp@gmail.com">nexcordapp@gmail.com</a>.
            </Text>
          </InformationContainer>
          ...
          <Block title="1. Terms" icon="contract">
            By accessing or using this website (https://nexcord.de), you
            ...
            website.{" "}
            <strong>
              Continued access to or use of Nexcord following the publication
          ...
          <Block title="2. Age Requirements" icon="cake">
            To use Nexcord or any associated services, you must be at least{" "}
          ...
          <Block title="3. Behaviour" icon="sports">
            ...
            doxxing <strong>are prohibited</strong> on Nexcord. However, if
            ...
            <div style={{ "margin-top": "15px" }}>
              <strong>
                ...
                absolutely prohibited on Nexcord.
              </strong>
            </div>
            <div style={{ "margin-top": "15px" }}>
          ...
          <Block title="4. Servers" icon="storage">
            Creating a server on Nexcord that involves exploitation of any game
          ...
          <Block title="5. Links" icon="link">
            Nexcord has not reviewed all sites connected to its Website and is
            not responsible for their contents. The presence of any link does
            not imply endorsement by Nexcord of the site. Any linked website is
          ...
          <Block title="7. Disclaimer" icon="warning">
            All Nexcord's Website materials are provided "as is". Nexcord
            makes no promises, expressly or impliedly, therefore negates all
            other warranties. Furthermore, Nexcord does not represent the
          ...
          <Block title="8. Limitations" icon="lock">
            Nexcord or its suppliers will not be held accountable for any
            damages that arise from the use or inability to use the materials on
            Nexcord's Website. This is even if Nexcord or an authorised
          ...
          <Block title="9. Revisions and Errata" icon="edit_document">
            Nexcord's Website may contain technical, typographical, or
            photographic errors. Nexcord does not promise that the materials on
            this Website are accurate, complete, or current. Nexcord may change
            its Website materials at any time without notice. Nexcord does not
          ...
          <Block title="11. Governing Law" icon="globe_uk">
            Any claim relating to Nexcord's Website shall be governed by the
