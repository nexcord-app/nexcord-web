      ...
      <Content class="content">
        <CenterContainer>
          <InformationContainer>
            <Title>Nexcord Privacy Policy</Title>
          ...
          <Block title="Data We Store Automatically" icon="storage">
            When registering an account on Nexcord and using its services, we
          ...
          <Block title="Data We Collect Automatically" icon="data_usage">
            While using Nexcord and its services, we store certain information
          ...
          <Block title="Voice Calling" icon="call">
            Voice calls on Nexcord are peer-to-peer, meaning your voice data is
          ...
          <Block title="Data Retention and Deletion" icon="delete">
            You can delete your Nexcord account at any time through your
          ...
          <Block title="Your Data Privacy" icon="lock">
            ...
            purposes. Your data is only used to operate and improve Nexcord's
            services.
          </Block>
