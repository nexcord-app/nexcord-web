  ...
  const members = createMemo(() =>
    (serverMembers.array(params.serverId!) as ServerMember[])
      .sort((a, b) => {
        ...
        if (sort().headerId === "joinedNexcord") {
      ...
      <div class={style.pane}>
        ...
        <Table.Root
          headers={[
            ...
            {
              title: t("channelDrawer.members.sort.joinedNexcord"),
              id: "joinedNexcord"
            },
            { title: t("servers.settings.drawer.roles"), id: "roles" }
          ]}
          sortableHeaderIds={["member", "joined", "joinedNexcord"]}
            ...
            {(member) => {
              ...
              return (
                ...
                >
                  ...
                  <Table.Field
                    mobileTitle={t("channelDrawer.members.sort.joinedNexcord")}
                  >
