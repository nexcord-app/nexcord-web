      ...
      <FlexRow class="language-and-socials" itemsCenter gap={10} justifyCenter>
        ...
        <SocialLinks gap={10} class="social-links">
          <CustomLink
            ...
            href="https://nexcord.de/i/nexcord"
            target="_blank"
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://twitter.com/nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://bsky.app/profile/nexcord.de"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://mastodon.social/@nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://www.reddit.com/r/nexcordchat"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://www.threads.com/@nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://www.youtube.com/@Nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://www.producthunt.com/posts/nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <CustomLink
            class={socialLinkStyle}
            href="https://supertigerdev.itch.io/nexcord"
            target="_blank"
            rel="noopener noreferrer"
          >
