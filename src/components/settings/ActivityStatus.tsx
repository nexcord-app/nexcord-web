      ...
      <RPCAdContainer>
        ...
        >
          <CustomLink
            ...
            href="https://addons.mozilla.org/firefox/addon/nexcord-rpc"
          >
            <Button
              margin={[10, 0, 0, 0]}
              iconName="extension"
          ...
          <CustomLink
            target="_blank"
            rel="noopener noreferrer"
            href="https://chromewebstore.google.com/detail/nexcord-rpc/lgboikjogeocndkamelapkbngmfjfgaf"
          >
            <Button
              margin={[10, 0, 0, 0]}
              iconName="extension"
