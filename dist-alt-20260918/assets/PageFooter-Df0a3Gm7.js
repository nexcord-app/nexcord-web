import{b as m,o as b,c as e,H as y,S as f,$ as v,Y as d,s as o,u as c,E as w,Z as k,G as S,m as L,I as D,p as C,x as I,y as F,aw as A,as as T,af as E,a1 as H,ak as u,F as Y}from"./useStore-C81yKXnX.js";import{I as p}from"./browser-QP6z6XX1.js";import{l as M}from"./logout-DfWc_cxe.js";import{S as l}from"./Skeleton-C81J_hd6.js";import{A as P}from"./Avatar-CnjpHkJi.js";const U={start:{day:25,month:10},dayDuration:9},h=Date.now(),z=N(U);function N({start:r,dayDuration:n}){const t=new Date;t.setDate(r.day),t.setMonth(r.month-1),t.setHours(0),t.setMinutes(0);const a=new Date(t);return a.setDate(t.getDate()+n),a.setHours(23),a.setMinutes(59),t.getFullYear()!==a.getFullYear()&&(a.setFullYear(t.getFullYear()),t.setFullYear(t.getFullYear()-1)),h>t.getTime()&&h<a.getTime()}const O=()=>z?"/assets/halloween-logo.png":"/assets/logo.png";var R=w("<a style=text-decoration:none>");const _=o("header")`
  display: flex;
  height: 58px;
  flex-shrink: 0;
  &:after {
...
//# sourceMappingURL=PageFooter-Df0a3Gm7.js.map
