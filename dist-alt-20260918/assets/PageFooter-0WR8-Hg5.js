import{o as S,c as e,A as _,S as L,W as D,X as w,e as I,r as j,v as T,f as F,m as M,I as P,t as C,i as b}from"./ModerationService-JKa8HDPL.js";import{s as g,u as d,a as h}from"./Flexbox-CKnPoiWr.js";import{o as U,U as A,V as N}from"./useStore-1zAIwTgm.js";import{I as y}from"./browser-BM56HFVq.js";import{S as m}from"./Skeleton-4ICHWQuq.js";import{A as Y,C as n,D as E}from"./Text-D1ScQjsd.js";import{L as H}from"./LogoutModal-kXTn1x57.js";import{l as k,g as O,a as $,s as z}from"./languages-zn42qa69.js";import{E as R}from"./ClanTag-DJCmGglO.js";import{L as X}from"./LogoMono-DMiy7BSM.js";const K={start:{day:25,month:10},dayDuration:9},v=Date.now();V(K);function V({start:t,dayDuration:s}){const r=new Date;r.setDate(t.day),r.setMonth(t.month-1),r.setHours(0),r.setMinutes(0);const a=new Date(r);return a.setDate(r.getDate()+s),a.setHours(23),a.setMinutes(59),r.getFullYear()!==a.getFullYear()&&(a.setFullYear(r.getFullYear()),r.setFullYear(r.getFullYear()-1)),v>r.getTime()&&v<a.getTime()}const q=()=>"/assets/logo.png",W=g("header")`
  display: flex;
  align-items: center;
  height: 58px;
  flex-shrink: 0;
...
//# sourceMappingURL=PageFooter-0WR8-Hg5.js.map
