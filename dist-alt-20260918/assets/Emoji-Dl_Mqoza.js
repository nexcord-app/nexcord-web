import{L as h,g as E,E as b,Z as j,p as x,c as t,a3 as y,b as S,o as w,T as v,S as f,aB as C,s as c,X as P,W as z,u as k,ac as I,K as M,a as N,af as L,as as o,b$ as R,a1 as A}from"./useStore-B0mu5xqR.js";import{A as B}from"./Avatar-Dm8O4A-8.js";import{S as V}from"./ServerVerifiedIcon-gLzI5TWF.js";import{u as D}from"./useJoinServer-Dg6-EmYl.js";var T=b("<img loading=lazy>",!0,!1,!1),F=b("<img loading=lazy style=object-fit:contain;width:60px;height:60px;border-radius:6px>",!0,!1,!1);function $(e){const{hasFocus:u}=h(),{createPortal:l}=E(),d=()=>{l(r=>t(H,y({close:r},e)))},s=()=>{if(!e.custom)return e.url;const r=new URL(e.url);return!u()&&e.animated&&r.searchParams.set("type","webp"),e.resize&&r.searchParams.set("size",e.resize.toString()),r.href};return(()=>{var r=T();return j(r,"click",e.clickable?d:void 0,!0),x(i=>{var a=N(e.class,"emoji"),n=s(),g=e.name,m=e.name;return a!==i.e&&L(r,i.e=a),n!==i.t&&o(r,"src",i.t=n),g!==i.a&&o(r,"alt",i.a=g),m!==i.o&&o(r,"title",i.o=m),i},{e:void 0,t:void 0,a:void 0,o:void 0}),r})()}const J=c.div`
  display: flex;
...
//# sourceMappingURL=Emoji-Dl_Mqoza.js.map
