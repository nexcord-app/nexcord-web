import{o as S,c as e,A as _,S as L,W as D,X as w,e as I,r as j,v as T,f as F,m as M,I as P,t as C,i as b}from"./ModerationService-DJHF7x8B.js";import{s as g,u as d,a as h}from"./Flexbox-CtT2pseo.js";import{o as U,U as A,V as N}from"./useStore-DBb0Z1Ja.js";import{I as y}from"./browser-R3nOtTKF.js";import{S as m}from"./Skeleton-Br6MF7Mb.js";import{A as Y,C as n,D as E}from"./Text-C_egcRFS.js";import{L as H}from"./LogoutModal-CUTnBZSd.js";import{l as k,g as O,a as $,s as z}from"./languages-DKaNROAR.js";import{E as R}from"./ClanTag-HmJJCvQp.js";import{L as X}from"./LogoMono-CDF5V_Vw.js";const K={start:{day:25,month:10},dayDuration:9},v=Date.now();V(K);function V({start:t,dayDuration:s}){const r=new Date;r.setDate(t.day),r.setMonth(t.month-1),r.setHours(0),r.setMinutes(0);const a=new Date(r);return a.setDate(r.getDate()+s),a.setHours(23),a.setMinutes(59),r.getFullYear()!==a.getFullYear()&&(a.setFullYear(r.getFullYear()),r.setFullYear(r.getFullYear()-1)),v>r.getTime()&&v<a.getTime()}const q=()=>"/assets/logo.png",W=g("header")`
  display: flex;
  align-items: center;
  height: 58px;
  flex-shrink: 0;
...
//# sourceMappingURL=PageFooter-DNOO5FCp.js.map
