import{o as S,c as e,A as _,S as L,W as D,X as b,e as I,r as j,v as T,f as F,m as M,I as P,t as C,i as y}from"./ModerationService-7nF9_67y.js";import{s as g,u,a as h}from"./Flexbox-DahX4I5v.js";import{o as U,U as A,V as N}from"./useStore-C1x_XtZn.js";import{I as w}from"./browser-ByxRPPz2.js";import{S as f}from"./Skeleton-fDFQMXJb.js";import{A as Y,C as n,D as E}from"./Text-xQnkEBKO.js";import{L as H}from"./LogoutModal-C-idJ6HJ.js";import{l as k,g as O,a as $,s as z}from"./languages-CyEDRxRF.js";import{E as R}from"./ClanTag-tgfDpOrD.js";import{L as X}from"./LogoMono-MQmPfyUk.js";const K={start:{day:25,month:10},dayDuration:9},v=Date.now();V(K);function V({start:r,dayDuration:s}){const t=new Date;t.setDate(r.day),t.setMonth(r.month-1),t.setHours(0),t.setMinutes(0);const a=new Date(t);return a.setDate(t.getDate()+s),a.setHours(23),a.setMinutes(59),t.getFullYear()!==a.getFullYear()&&(a.setFullYear(t.getFullYear()),t.setFullYear(t.getFullYear()-1)),v>t.getTime()&&v<a.getTime()}const q=()=>"/assets/logo.png",W=g("header")`
  display: flex;
  align-items: center;
  height: 58px;
  flex-shrink: 0;
...
//# sourceMappingURL=PageFooter-31voP2kt.js.map
