...
export const getIntegerOrZero = (value) => Number.isInteger(value) ? value : 0;
export const createMainAxisPositions = (measurements, axis, getOverscan) => {
    ...
    createComputed(() => {
        ...
        untrack(() => {
            ...
            const overscanNotSafe = getOverscan() ??
    ...
    createComputed(() => {
        ...
        const scrollValueAdjusted = measurements.mainAxisScrollValue - measurements.container.offsetMain;
